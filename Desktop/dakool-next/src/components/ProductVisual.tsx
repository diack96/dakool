...
const shapes: Record<string, React.ReactNode> = {
  Maillots: (
    <>
      ...
      <path d="M100 96 L100 174" className="stroke-teranga" strokeWidth={3} />
  ...
  Chaussures: (
    <>
      ...
      <path d="M24 150 L172 130" className="stroke-teranga" strokeWidth={3} />
  ...
  Ballons: (
    <>
      ...
      <path d="M100 62 L130 84 L118 120 L82 120 L70 84 Z" className="fill-teranga/15 stroke-teranga" />
  ...
  Équipements: (
    <>
      ...
      <path d="M86 80 L86 162 M114 80 L114 162" className="stroke-teranga" strokeWidth={3} />
  ...
  Accessoires: (
    <>
      ...
      <path d="M154 118 Q188 120 190 134 L40 134 Q40 120 46 118 Z" className="fill-teranga/15 stroke-teranga" />
  ...
  return (
    <div className={`relative flex h-full w-full items-center justify-center ${className}`}>
      {index !== undefined && (
        <span
          aria-hidden
          className="pointer-events-none absolute inset-0 flex items-center justify-center font-display text-[9rem] leading-none text-white/[0.04] select-none"
        >
      ...
      <svg
        ...
        aria-hidden
        className="relative w-[62%] text-white/85 transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-110"
      >
        {shape}
      </svg>
    </div>
