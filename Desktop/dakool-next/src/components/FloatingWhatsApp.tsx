...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="group fixed right-5 bottom-5 z-30 flex items-center gap-0 bg-[#25D366] text-black shadow-lg shadow-black/40 transition-[gap] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:gap-2.5 sm:right-6 sm:bottom-6"
    >
