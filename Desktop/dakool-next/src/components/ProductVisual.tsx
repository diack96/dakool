...
const shapes: Record<string, React.ReactNode> = {
  Maillots: (
    <>
      ...
      <path d="M100 96 L100 174" className="stroke-white" strokeWidth={3} />
  ...
  Chaussures: (
    <>
      ...
      <path d="M24 150 L172 130" className="stroke-white" strokeWidth={3} />
  ...
  Ballons: (
    <>
      ...
      <path d="M100 62 L130 84 L118 120 L82 120 L70 84 Z" className="fill-white/10 stroke-white" />
  ...
  Équipements: (
    <>
      ...
      <path d="M86 80 L86 162 M114 80 L114 162" className="stroke-white" strokeWidth={3} />
  ...
  Accessoires: (
    <>
      ...
      <path d="M154 118 Q188 120 190 134 L40 134 Q40 120 46 118 Z" className="fill-white/10 stroke-white" />
