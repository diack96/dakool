...
export const products: Product[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Tarifs dégressifs à partir de 200 sacs',
    ],
    inStock: true,
  },
  {
    ...
    details: [
      ...
      'Franges nouées',
      'Environ 140 × 17 cm',
      'Tarifs dégressifs à partir de 200 pièces',
    ],
    inStock: true,
  },
  {
  ...
  },
  {
    ...
    details: [
      ...
      'Tarifs dégressifs à partir de 200 ensembles',
    ],
    inStock: true,
  },
  {
  ...
  {
    id: 'sv1b',
    slug: 'sous-vetement-manches-longues',
    name: 'Sous-vêtement Manches Longues',
    category: 'Sous-vêtements',
    price: 18,
    badge: { label: 'Sur mesure' },
    personnalisable: true,
    images: [
      '/produits/sousvet-marine.jpg',
      '/produits/sousvet-noir.jpg',
      '/produits/sousvet-jaune.jpg',
      '/produits/sousvet-rouge.jpg',
      '/produits/sousvet-blanc.jpg',
    ],
    tagline: 'La couche qu’on met en premier et qu’on oublie.',
    description:
      "Maillot de corps à manches longues, coupe compressive, porté à même la peau sous la tenue. La maille extensible dans les deux sens suit le mouvement sans gêner l'épaule, évacue la transpiration et sèche vite. Coutures plates pour ne pas irriter sous un maillot de match.",
    sizes: JERSEY_SIZES,
    colors: [
      { name: 'Marine', hex: '#1E3A8A', images: ['/produits/sousvet-marine.jpg'] },
      { name: 'Noir', hex: '#1A1A1A', images: ['/produits/sousvet-noir.jpg'] },
      { name: 'Jaune', hex: '#F2C200', images: ['/produits/sousvet-jaune.jpg'] },
      { name: 'Rouge', hex: '#D62222', images: ['/produits/sousvet-rouge.jpg'] },
      { name: 'Blanc', hex: '#F2F2F2', images: ['/produits/sousvet-blanc.jpg'] },
    ],
    details: [
      'Coupe compressive, portée à même la peau',
      'Maille extensible dans les deux sens',
      'Évacuation de la transpiration, séchage rapide',
      'Coutures plates',
      'Cinq coloris pour s’accorder au maillot',
    ],
    inStock: true,
  },
  {
    id: 'sv2b',
    slug: 'brassiere-de-sport',
    name: 'Brassière de Sport',
    category: 'Sous-vêtements',
    price: 16,
    personnalisable: true,
    images: ['/produits/brassiere-sport.jpg'],
    tagline: 'Dos nageur, maintien moyen, rien qui bouge.',
    description:
      "Brassière à dos nageur, sans armature, avec bande élastique large sous la poitrine. Le maintien est moyen : assez ferme pour l'entraînement collectif et le match, sans la rigidité d'une brassière de course. Se porte seule ou sous le maillot.",
    sizes: YOGA_SIZES,
    colors: [{ name: 'Gris anthracite', hex: '#3E3A42' }],
    details: [
      'Dos nageur, sans armature',
      'Bande élastique large sous la poitrine',
      'Maintien moyen',
      'Maille respirante, séchage rapide',
    ],
    inStock: true,
  },
  {
